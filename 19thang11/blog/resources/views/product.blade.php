							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">		
									...
									<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="{{asset('images/'. $value->image)}}" class="img-responsive" alt="">
										<div class="offer"><p><span>Offer</span></p></div>
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">{{$value['name']}}</a>(1 kg)</h6>							
										</div>
										<div class="mid-2">
											<p ><label>$2.00</label><em class="item_price">{{$value['price']}}</em></p>
											  <div class="block">
